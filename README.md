...
## 💻 專案集
### 2026
- 🔐 [Postgres+Go+Gin+React交易所(無Clerk版本)](https://github.com/Vic428-human/marketplace-withoutClerk) => 不透過Clerk完成金流、會員系統，真正意義上的深度學習後端，任何後端技術的功能都會優現在這個專案實踐
- 🤖 [websocket+go+react的多人聊天室](https://github.com/Vic428-human/websocket-golang-chat-room) => 已完成原型，預計放在交易所內
- 🔐 [Go+SSE+SQLite+go template接單系統](https://github.com/Vic428-human/go-pizza-order-tracker) => 當時用於理解 SSE是如何在後端運作，並同時熟悉Go的使用，也預期會把這邊運用到的SSE觀念，運用在交易所的APP
- 💫 [Gin+PostgreSQL+JWT獨立環境單獨測試API](https://github.com/Vic428-human/todoapp-jwt) => 模擬API情境，又不想污染其他主要專案時，會優先在這測試，例如阻擋贓資料的功能、CRUD..等功能
- ⚛️ [React+nodejs+postgres+express+clerk交易所](https://github.com/Vic428-human/social-media-marketplace) => 透過Clerk完成金流、會員系統，任何前端的功能都會優先在這個專案實踐，像是廣告彈窗、紅包外觀的UI設計、旋轉木馬風格的交易所競拍區...等
